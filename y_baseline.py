...
y = y_age
d = pd.Series(y).value_counts().to_dict()
yhat = np.zeros((3200,len(d)))
for k in d:
    yhat[:,k] = d[k]/3200
print('mlogloss:',mlogloss(yhat,y))
print('macc:',macc(yhat,y))
prds.append(yhat)
prds.append(y)
...
n = len(df_sub)
df_sub['age'] = age_le.inverse_transform(prds[0][:n].argmax(axis=1))
df_sub['gender'] = sex_le.inverse_transform(prds[2][:n].argmax(axis=1))
df_sub['province'] = loc_le.inverse_transform(prds[4][:n].argmax(axis=1))
df_sub.to_csv('./predictions/temp.csv',index=None)

# mlogloss: 0.956884833064
# macc: 0.5609375
# mlogloss: 0.555364063882
# macc: 0.75625
# mlogloss: 1.73154423162
# macc: 0.29875
# age mlogloss: 0.956884833064
# age macc: 0.5609375
# sex mlogloss: 0.555364063882
# sex macc: 0.75625
# loc mlogloss: 1.73154423162
# loc macc: 0.29875
# LB score: 0.46890625

# LB score:0.459489795918367.